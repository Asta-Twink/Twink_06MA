...
DROP TABLE IF EXISTS `cleaning_crew`;
...
LOCK TABLES `cleaning_crew` WRITE;
/*!40000 ALTER TABLE `cleaning_crew` DISABLE KEYS */;
/*!40000 ALTER TABLE `cleaning_crew` ENABLE KEYS */;
UNLOCK TABLES;
